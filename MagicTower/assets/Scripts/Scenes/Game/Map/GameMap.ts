...
// import { LevelInfo } from "../../../Data/MapInfo";
// import { Util } from "../../../Util/Util";
// import CalculateSystem from "../System/CalculateSystem";
// import { ElementManager } from "../ElementManager";
// import { GameManager } from "../../../Managers/GameManager";
// import GameEventSystem from "../System/GameEventSystem";
// import Door from "../Elements/Door";
// import NpcInteractiveSystem from "../System/NpcInteractiveSystem";
// import MonsterFightSystem from "../System/MonsterFightSystem";
...
//         //switch (tileType) {
//         //case "floor":
//         //return this.hero.HeroInfo.Hp > this.getWizardMagicDamage(index);
//         //case "monster":
//         //return CalculateSystem.canHeroAttack(this.hero.HeroInfo, element.monsterInfo, !element.firstAttack);
//         //case "door":
//         //return element.hide;
//         //}
...
//         //if ((this.monsterInfo.bigMonster && this.monsterInfo.bigMonster.indexOf(index) != -1) || this.hero.HeroInfo.Hp <= this.getWizardMagicDamage(index)) return false;
...
//         //let diff = Math.abs(parseInt(index) - this.tileToIndex(this.hero.HeroInfo.Position));
...
//         //case "monster":
//         //{
//         //if (!CalculateSystem.canHeroAttack(this.hero.HeroInfo, element.monsterInfo, !element.firstAttack)) {
...
//         //.showDialog("ShopDialog", this.shopInfo, this.hero.HeroInfo.Gold, (attr: string) => {
//         //switch (attr) {
//         //case "hp":
...
//         //if (attr != "no") {
//         //this.hero.HeroInfo.Gold -= this.shopInfo.buy();
...
//         //let magic = false;
//         //if (!this.hero.HeroInfo.equipedDivineShield()) {
...
//         //if (this.hero.HeroInfo.Hp <= wizardDamage) {
...
//         //let direction = heroInfo.Direction;
//         //let index = this.tileToIndex(heroInfo.Position) + HERO_FACE_DIRECTION[direction];
...
//     }
//     removeLava() {
//         //let heroIndex = this.tileToIndex(this.hero.HeroInfo.Position);
...
//     }
//     centrosymmetricFly() {
//         //let tile = this.hero.HeroInfo.Position;
...
// // let DIRECTION_INDEX_DIFFS = {
// //     "-1": cc.Vec2.RIGHT,
// //     "1": cc.Vec2.RIGHT.clone().negate(),
// //     "-11": cc.Vec2.UP.clone().negate(),
// //     "11": cc.Vec2.UP,
// // };
// //
// // /** 英雄面朝方向上，右，下，左 */
...
// //
// // @ccclass
// // export class GameMap extends cc.Component implements AstarMap {
// //     /** 地图层 */
// //     private layers = {};
// //
// //     /** 地图数据 */
...
// //
// //     /** 地图一半大小 */
// //     private mapHalfSize: cc.Vec2 = null;
// //
// //     private propParser: PropParser = null;
// //
// //     /** 终点可以走的地块 */
...
// //
// //     /** 弹窗调整位置*/
// //     private _dialogPos: cc.Vec2 = cc.v2(0, 50);
// //
// //     /** a*寻路isEmpty判断类型 */
// //     private _astarMoveType: string = "hero";
// //
...
// //      * @param pivot 默认指定tile格子的中心
// //      */
// //     tileToNodeSpaceAR(tileCoord: cc.Vec2, pivot: cc.Vec2 = null) {
// //         pivot = pivot || cc.v2(0.5, 0.5);
// //         let temp = tileCoord.add(pivot);
// //         return cc.v2(temp.x * this.mapData.tileWidth - this.mapHalfSize.x, this.mapHalfSize.y - temp.y * this.mapData.tileHeight);
// //     }
...
// //      * @param nodeCoord nodeAR坐标
// //      */
// //     nodeSpaceARToTile(nodeCoord: cc.Vec2) {
// //         let screenCoord = cc.v2(nodeCoord.x, -nodeCoord.y).addSelf(this.mapHalfSize);
// //         return cc.v2(Math.floor(screenCoord.x / this.mapData.tileWidth), Math.floor(screenCoord.y / this.mapData.tileHeight));
// //     }
// //
...
// //     }
// //
// //     private heroMoveJudge(tile: cc.Vec2, endTile: cc.Vec2) {
// //         let { tileType, index } = this.getTileInfo(tile);
// //
// //         if ((this.monsterInfo.bigMonster && this.monsterInfo.bigMonster.indexOf(index) != -1) || this.hero.HeroInfo.Hp <= this.getWizardMagicDamage(index)) return false;
// //
...
// //     }
// //
// //     private elementMoveJudge(tile: cc.Vec2) {
// //         let { tileType } = this.getTileInfo(tile);
// //
// //         return tileType == "floor" || tileType == "monster" || tileType == "event" || tileType == "stair";
// //     }
